...
csv_file_path = "res/figureCloudFogCSV.csv"
    ...
    for cur_conf in configs:
        for i in range(repetitions):
            ...
            with open(csv_file_path, mode="a", newline="") as file:
                writer = csv.writer(file)
                writer.writerow(
                    [timestamp, test_env['name'], i + 1, cur_conf['read_par'], cur_conf['deser_par'],
                     cur_conf['comp_par'],
