...
RUN_SECTION_02 = False  # Figure 17a (Memory Management)                : figureMemoryManagement.csv (N24*)
RUN_SECTION_03 = False  # Figure 11b (Physical Nodes)
RUN_SECTION_04 = False  # Figures 10a & 10b (Parquet/CSV Comparison)    : figureZParquetCSV.csv (N28)
RUN_SECTION_05 = False  # Figure 11a (Skip Serialization)                : figure11.csv (N24*)
RUN_SECTION_06 = False  # Figure 14a (Arrow Formats)                     : figureXArrow.csv (N24)
RUN_SECTION_07 = False  # Figures 19a & 19b (Compression Scaling)      : figure17b.csv (N24*)
RUN_SECTION_08 = False  # Figure 17b (Network vs. Compression)          : figure17b.csv (N24*)
RUN_SECTION_09 = False  # Figure 18 (Buffer Size vs. Compression/Format) : figure18.csv (N24*)
RUN_SECTION_10 = False  # Figure 16a (Parallelism Scaling - Env 1)      : figure1516a.csv (N24)
RUN_SECTION_11 = False  # Figure 16b (Config Comparison - Env 1)         : figure1516b.csv (N24)
